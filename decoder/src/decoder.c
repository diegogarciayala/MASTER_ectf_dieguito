 ...
 */
 ...
 /* Incluir primero las opciones de wolfSSL para configurar la librería */
 #include <wolfssl/options.h>
 #include <wolfssl/wolfcrypt/cmac.h>  // Proporciona wc_AesCmac
 ...
 /* AES-CTR implementado usando encrypt_sym().
